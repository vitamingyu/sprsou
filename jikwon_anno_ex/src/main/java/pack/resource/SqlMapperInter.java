...
public interface SqlMapperInter {
	@Select("select jikwon_no, jikwon_name, ifnull(buser_name,'무소속') as buser_name, substr(jikwon_ibsail,1,4) as ib from jikwon left outer join buser on buser_num=buser_no")
	...
	@Select("select buser_name, count(*) as inwon from buser inner join jikwon on buser.buser_no=jikwon.buser_num group by buser_name")
